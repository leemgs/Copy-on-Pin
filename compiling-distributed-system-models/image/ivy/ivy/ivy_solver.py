...
if hasattr(z3, '_to_ast_array'):
    z3_to_ast_array = z3._to_ast_array
else:
    from z3.z3 import _to_ast_array as z3_to_ast_array
if hasattr(z3, '_to_expr_ref'):
    z3_to_expr_ref = z3._to_expr_ref
else:
    from z3.z3 import _to_expr_ref as z3_to_expr_ref
